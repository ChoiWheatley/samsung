...
public:
  ...
  void updateTeam(int mTeam, int mChangeScore) {
    ...
    foreach_true(result, [this, mChangeScore](int id) {
...
static SoldierController sc;

inline void init() { sc = SoldierController(); }

inline void hire(int mID, int mTeam, int mScore) {
  sc.hire(mID, mTeam, mScore);
}

inline void fire(int mID) { sc.fire(mID); }

inline void updateSoldier(int mID, int mScore) {
  sc.updateSoldier(mID, mScore);
}

inline void updateTeam(int mTeam, int mChangeScore) {
  sc.updateTeam(mTeam, mChangeScore);
}

inline int bestSoldier(int mTeam) { return sc.bestSoldier(mTeam); }
